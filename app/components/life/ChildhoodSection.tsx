        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start mb-32">
          <div className="md:col-span-12">
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              className="text-2xl md:text-4xl font-serif italic text-primary leading-tight"
            >
              In the ERA courtyard, children will invent a hundred ways to
              follow their own nature. Next to the central park there is a green
              labyrinth. This is the best place to combine catching up with
              hide-and-seek.
            </motion.p>
          </div>
        </div>
